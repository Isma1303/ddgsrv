...
import { DepartmentMembersController } from './department_members.controller'

const router = Router()
const endPoint = '/ddg/department-members'
const controller = new DepartmentMembersController()
...
const departmentMembersRouter: Route = { endPoint, router }

export default departmentMembersRouter
