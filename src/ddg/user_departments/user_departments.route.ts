...
const router = Router()
const endPoint = '/ddg/user-departments'
const controller = new UserDepartmentsController()
...
const userDepartmentsRouter: Route = { endPoint, router }

export default userDepartmentsRouter
