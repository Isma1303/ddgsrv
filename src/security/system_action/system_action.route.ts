...
import { getAuthorizationMiddleware } from '../../system/utils/auth.utils'
import { getAuthenticationMiddleware } from '../../system/utils/auth.utils'
import Route from '../../system/interfaces/route.interface'
import SystemActionController from './system_action.controller'

const router = Router()
const endPoint = '/system_actions'
const controller = new SystemActionController()
...
const systemActionRoute: Route = { endPoint, router }

export default systemActionRoute
