...
import WorkerRunningJobController from './worker_running_job.controller'
...
const workerRunningJobRouter: Route = { endPoint, router }

export default workerRunningJobRouter
