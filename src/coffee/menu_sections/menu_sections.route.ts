...
import { MenuSectionsController } from './menu_sections.controller'

const router = Router()
const endPoint = '/coffee/menu-sections'
const controller = new MenuSectionsController()
...
const menuSectionsRouter: Route = { endPoint, router }
