...
import { SaleStatusController } from './sale_status.controller'

const router = Router()
const endPoint = '/coffe/sale-status'
const controller = new SaleStatusController()
...
const saleStatusRouter: Route = { endPoint, router }

export default saleStatusRouter
