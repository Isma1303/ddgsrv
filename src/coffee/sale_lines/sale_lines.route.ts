...
import { SaleLinesController } from './sale_lines.controller'

const router = Router()
const endPoint = '/coffee/sale-lines'
const controller = new SaleLinesController()
...
const saleLinesRouter: Route = { endPoint, router }

export default saleLinesRouter
